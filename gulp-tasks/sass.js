///
// TITLE: gulpfile.js
// PURPOSE: Module file used for SASS tasks. 
...
//Variables
const {dist, src} = require ('gulp');
const cleanCSS = require('gulp-clean-css');
const sassProcessor = require ('gulp-css');
...
const sass = () =>
{
    return src('./src/scss/*.scss')
        ...
        .pipe(dist(calculateOutput, {sourceMaps: !isProduction}));
};
